...
export default function Card({ title, price, rating, reviews, image, variant = "vertical" }) {
  if (variant === "horizontal") {
    // Horizontal card
    return (
      <div className="flex border p-4 rounded shadow-md w-96 items-center gap-4">
  ...
  return (
    <div className="p-2 rounded shadow-md w-60 my-1">
        ...
        <div className="mt-2 flex items-center justify-between">
            ...
            <div className="flex flex-col items-end">
                ...
                <span className={`${plusJakartaSans.className} text-[#76777C] font-[600] text-md`}>
                    ${price}
                </span>
            </div>
        </div>
